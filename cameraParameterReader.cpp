...
cv::Mat loadOCamCalibMatrix(string path){

    cv::Mat data = cv::Mat::zeros(480, 640, CV_32F);
    ...
    for(int row = 0; row < 480; ++row)
    {
        ...
        for (int col = 0; col < 640; ++col)
        {
            ...
            std::stringstream convertor(val);
            // convertor >> data.at<double>(row, col);
            convertor >> d;

            // cout.precision(24);
            // cout << d << endl;

            data.at<float>(row, col) = d;

            // cout.precision(24);
            // cout << data.at<float>(row, col) << endl;
            // cout << endl;
...
// double mapx_persp_32[720][1280];
// loadOCamCalibMatrix(mapx_persp_32, "posefusion/mapx_persp_32.csv");

// double mapy_persp_32[720][1280];
// loadOCamCalibMatrix(mapy_persp_32, "posefusion/mapy_persp_32.csv");

// const cv::Mat cv_mapx_persp_32(720, 1280, CV_32F, mapx_persp_32);
// const cv::Mat cv_mapy_persp_32(720, 1280, CV_32F, mapy_persp_32);
        ...
        try
        {
            if (spImpl->mUndistortImage)
            {
                    ...
                    || spImpl->mRemoveDistortionMaps2[cameraIndex].empty())
                {
                    ...
                    // GRG Code
                    // opLog("GRG - Distort being called", Priority::High);
                    // cout << "GRG - Distort being called";

                    // double mapx_persp_32[480][640];
                    // cv::Mat cv_mapx_persp_32(480, 640, CV_32F);
                    // cv::Mat cv_mapx_persp_32 = cv::Mat::zeros(480, 640, CV_32F);
                    cv::Mat cv_mapx_persp_32 = loadOCamCalibMatrix("posefusion/mapx_persp_32_sm.csv");

                    // cout << "GRG - reached";

                    // double mapy_persp_32[480][640];
                    // cv::Mat cv_mapy_persp_32(480, 640, CV_32F);
                    // cv::Mat cv_mapy_persp_32 = cv::Mat::zeros(480, 640, CV_32F);
                    cv::Mat cv_mapy_persp_32 = loadOCamCalibMatrix("posefusion/mapy_persp_32_sm.csv");

                    // cv::Mat cv_mapx_persp_32(480, 640, CV_32F, mapx_persp_32);
                    // cv::Mat cv_mapy_persp_32(480, 640, CV_32F, mapy_persp_32);
                    ...
                    // cv::Mat cv_mapx_persp_32(720, 1280, CV_32F, mapx_persp_32);
                    // cv::Mat cv_mapy_persp_32(720, 1280, CV_32F, mapy_persp_32);

                    // cout.precision(25);
                    // cout << mapx_persp_32[1][639];
                    // cout << '\n';

                    // cout.precision(25);
                    // cout << mapy_persp_32[1][639];
                    // cout << '\n';
                    // cout << '\n';

                    // cout.precision(25);
                    // cout << cv_mapx_persp_32.at<double>(1, 639);
                    // cout << '\n';

                    // cout.precision(25);
                    // cout << cv_mapy_persp_32.at<double>(1, 639);
                    // cout << '\n';
                    // cout << '\n';

                    spImpl->mRemoveDistortionMaps1[cameraIndex] = cv_mapx_persp_32;
                    spImpl->mRemoveDistortionMaps2[cameraIndex] = cv_mapy_persp_32;

                    // cv::Mat a = spImpl->mRemoveDistortionMaps1[cameraIndex];

                    // cv::Mat b = spImpl->mRemoveDistortionMaps2[cameraIndex];

                    // cout.precision(25);
                    // cout << a.at<double>(1, 639);
                    // cout << '\n';

                    // cout.precision(25);
                    // cout << b.at<double>(1, 639);
                    // cout << '\n';
                ...
                // cv::Mat cv_mapy_persp_32(720, 1280, CV_32F, mapy_persp_32);
                // cout.precision(25);
                // cout << mapx_persp_32[719][1279];
                // cout << '\n';

                // cout.precision(25);
                // cout << mapy_persp_32[719][1279];
                // cout << '\n';

                // double mapx_persp_32[480][640];
                // loadOCamCalibMatrix(mapx_persp_32, "posefusion/mapx_persp_32_sm.csv");

                // double mapy_persp_32[480][640];
                // loadOCamCalibMatrix(mapy_persp_32, "posefusion/mapy_persp_32_sm.csv");

                // cv::Mat cv_mapx_persp_32(480, 640, CV_32F, mapx_persp_32);
                // cv::Mat cv_mapy_persp_32(480, 640, CV_32F, mapy_persp_32);
                // cout.precision(25);
                // cout << mapx_persp_32[479][639];
                // cout << '\n';

                // cout.precision(25);
                // cout << mapy_persp_32[479][639];
                // cout << '\n';
