...
if __name__ == '__main__':
    ...
    while True:
        ...
        if switch:
            client.publish(TOPIC_3D, messageA, personA)
            # time.sleep(2)
        else:
            # client.publish(TOPIC_3D, messageB, personB)
            pass
            # time.sleep(2)
